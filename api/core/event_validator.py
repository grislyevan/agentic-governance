...
_ALLOWED_TOP_LEVEL_KEYS = frozenset({
    ...
    "policy", "approval", "exception", "evidence", "evidence_details",
    "enforcement", "outcome", "severity", "posture",
    "mitre_attack", "correlation_context", "cross_tree_correlation", "agent_status", "telemetry_providers",
...
def validate_event_payload(data: dict[str, Any]) -> list[str]:
    ...
    for field in ("tool", "actor", "endpoint", "policy", "severity",
                   ...
                   "approval", "exception", "evidence", "evidence_details", "posture", "mitre_attack",
                   "cross_tree_correlation", "agent_status"):
        val = data.get(field)
