...
Invoked after event ingest as a background task (see api/routers/events.py
_run_playbooks_background). Matches the event against playbook triggers and
runs the configured actions: audit log, webhook (via existing dispatcher),
and optionally enforcement push.
"""
