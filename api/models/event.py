...
class Event(Base):
    ...
    __table_args__ = (
        UniqueConstraint("tenant_id", "event_id", name="uq_events_tenant_event_id"),
    ...
    endpoint_id: Mapped[str | None] = mapped_column(String(36), ForeignKey("endpoints.id", ondelete="SET NULL"), index=True)
