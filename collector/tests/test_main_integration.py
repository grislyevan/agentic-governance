...
class TestRunScanCleanSystem:
    ...
    def test_clean_scan(self):
        ...
        with (
            ...
            patch("main.OpenInterpreterScanner") as m5,
            patch("main.OpenClawScanner") as m6,
            patch("main.AiderScanner") as m7,
            patch("main.LMStudioScanner") as m8,
            patch("main.ContinueScanner") as m9,
            patch("main.GPTPilotScanner") as m10,
            patch("main.ClineScanner") as m11,
