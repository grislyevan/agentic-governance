  ...
  return (
    <div
      ...
      className={[
        ...
        'flex items-center gap-3 px-4 py-3 rounded-detec',
        ...
        isError
          ...
          : 'bg-detec-surface border-detec-ui-border text-detec-ink-primary',
      ].join(' ')}
    >
      {isError ? (
        ...
        <svg className="shrink-0 text-detec-brand" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" aria-hidden="true">
      ...
      <button
        ...
        className="shrink-0 text-detec-ink-secondary hover:text-detec-ink-primary"
        aria-label="Dismiss"
      >
