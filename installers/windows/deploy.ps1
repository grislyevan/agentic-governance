...
$ServerDist   = "$InstallDir\installers\windows\dist\detec-server"
$AgentDist    = "$InstallDir\installers\windows\dist\detec-agent"
...
Push-Location "$InstallDir\installers\windows"
$ErrorActionPreference = "Continue"
