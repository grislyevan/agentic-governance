...
#
# Optional:
#   Place a macOS .pkg in installers/windows/dist/detec-server/dist/packages/
...
#
# Output:
#   installers\windows\dist\DetecServerSetup-<version>.exe
#   installers\windows\dist\DetecAgentSetup-<version>.exe
...
$PackagingDir = "$RepoRoot\installers\windows"
