...
- **Approval Required decisions produce a hold label but do not currently block execution pending human review.** The hold label is logged and surfaced in the dashboard, but execution continues. Blocking execution pending approval is a Roadmap capability.
