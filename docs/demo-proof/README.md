...
| [DETEC-BEH-CORE-04-demo.md](DETEC-BEH-CORE-04-demo.md) | Polished demo for **DETEC-BEH-CORE-04** (agent execution chain): command, detection output, evidence summary, policy result. Showable in 60 seconds. |
