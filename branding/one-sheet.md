...
- **Detection confidence varies by tool and environment.** High-risk autonomous tools are often reported at Medium confidence (process/file anchors); EDR or kernel telemetry improves network and behavior attribution.
